...
#
# Modify by: José Miguel Guerrero Hernández
...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(mocap_dir, 'models', 'world_only.model'),
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(mocap_dir, 'models', 'waffle.model'),
    ...
    urdf = os.path.join(mocap_dir, 'urdf', 'turtlebot3_waffle.urdf')
